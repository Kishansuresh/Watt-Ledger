    ...
    <section className="p-6 space-y-6 max-w-7xl w-full mx-auto">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-400">
          Compare energy-efficiency performance and recognize
          the strongest conservation improvements.
        </p>
      </div>
        ...
        <div className="mb-5 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-slate-500">
              Higher scores indicate stronger modeled efficiency.
            </p>
          </div>
          ...
          {sortedTenants.map((tenant, index) => {
            ...
            return (
              <div
                ...
                className="flex flex-col gap-4 rounded-xl border border-slate-800 bg-slate-900/60 p-4 md:flex-row md:items-center"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {tenant.category || tenant.type || "Facility tenant"}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between gap-3 md:min-w-[150px] md:justify-end">
                  ...
                  <span
                    className={`text-sm font-bold ${
                      String(tenant.reduction || "").startsWith("-")
                        ? "text-rose-400"
                        : "text-emerald-400"
                    }`}
                  >
